...
class FileCrawler(object):
    """
           ...
           call FileCrawler.locateExecutablePath() with full name or part name of the file to be found

           :param JSONData_file_preferences : A JSON Array containing path to user custom searchable directories
